...
class RefCOCOMapper:
    ...
    def __call__(self, dataset_dict):
        ...
        if self.is_train:
            ...
            feature_file_path = '/root/autodl-tmp/data/tmp/feature_train.pkl'
            tmp_dic = {
                'image': src_image,
                'text_input': sentence_raw,
                'convert_image': dataset_dict['image'],
                'lang_tokens': dataset_dict['lang_tokens'],
                'lang_mask': dataset_dict['lang_mask'],
            }
            pickle.dump(tmp_dic, open(feature_file_path, 'wb'))
            exit()
